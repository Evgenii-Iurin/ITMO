...
def move():
    ...
    if any(obstacle['x'] == new_position['x'] and obstacle['y'] == new_position['y'] for obstacle in obstacles):
        return jsonify({ 'gameOver': True, 'state': { 'player': player_position, 'flag': flag_position, 'obstacles': obstacles, 'vision_radius': vision_radius } })

    # Check if player reached the flag
    if new_position == flag_position:
        return jsonify({ 'won': True, 'state': { 'player': player_position, 'flag': flag_position, 'obstacles': obstacles, 'vision_radius': vision_radius } })

    # Update player position
    player_position = new_position
    return jsonify({ 'state': { 'player': player_position, 'flag': flag_position, 'obstacles': obstacles, 'vision_radius': vision_radius } })
